 ...
 */
final class SchemaValuesValidatorTest extends KernelTestCase
{
    private SchemaValuesValidator $validator;

    protected function setUp(): void
    {
        self::bootKernel();
        $validator = self::getContainer()->get(SchemaValuesValidator::class);
        self::assertInstanceOf(SchemaValuesValidator::class, $validator);
