 ...
 */
final class FormValuesValidatorTest extends KernelTestCase
{
    private FormValuesValidator $validator;

    protected function setUp(): void
    {
        self::bootKernel();
        $validator = self::getContainer()->get(FormValuesValidator::class);
        self::assertInstanceOf(FormValuesValidator::class, $validator);
