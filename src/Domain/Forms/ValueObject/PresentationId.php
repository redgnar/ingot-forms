...
/**
 * Which stored presentation we are talking about. A UUIDv7 like {@see FormId},
 * minted by the server when a presentation is stored and never by a client.
 *
 ...
 * that `definition($presentationId)` is a compile-time mistake rather than a row
 * that is not there.
 */
final readonly class PresentationId implements \Stringable
{
