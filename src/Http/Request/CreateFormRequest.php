...
use App\Http\Request\Constraint\ValidFormDefinition;
...
final readonly class CreateFormRequest
{
    ...
    public function __construct(
        ...
        #[OA\Property(
            description: 'The form definition: id, title and 1–50 typed fields with unique names, per the meta-schema in src/Domain/Forms/form-definition.schema.json. Immutable once created — changing it means deleting the form and creating a new one.',
            type: 'object',
            example: ['id' => 'contact', 'title' => 'Contact us', 'fields' => [['type' => 'text', 'name' => 'email', 'required' => true]]],
        )]
